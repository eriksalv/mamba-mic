...
def evaluate_cell_detection_batch(pred_cells_list, pred_classes_list, gt_cells_list, gt_classes_list, max_distance=15):
    ...
    for pred_cells, pred_classes, gt_cells, gt_classes in zip(
        pred_cells_list, pred_classes_list, gt_cells_list, gt_classes_list
    ):
        tp_bc, fp_bc, fn_bc, tp_tc, fp_tc, fn_tc = evaluate_cell_detection(
            pred_cells, pred_classes, gt_cells, gt_classes, max_distance=max_distance
        )
